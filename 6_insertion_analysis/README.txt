...
In this folder, I analysed the total number of polymorphic insertions in each population (together and differentiating insertions shared with / absent from the reference), as well as the number of heterozygous sites
